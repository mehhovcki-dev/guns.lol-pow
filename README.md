...
## BE AWARE!
this project is for **educational purposes** - to show the process of solving Proof-of-Work captchas. this **SHALL NOT** be used for anything rather than learning how guns.lol Proof of Work captcha works. this **SHALL NOT BE USED** to bot views, or any action that involves their PoW captcha as it is prohibited by [guns.lol's terms of service](https://guns.lol/terms):
